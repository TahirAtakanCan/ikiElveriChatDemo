...
func startChat(user1: User, user2: User) -> String {
    ...
    let chatRoomId = chatRoomId(user1Id: user1.id, user2Id: user2.id)
...
func chatRoomId(user1Id: String, user2Id: String) -> String {
    
    var chatRoomId = ""
    
    let value = user1Id.compare(user2Id)
    
    chatRoomId = value.rawValue < 0 ? (user1Id + user2Id) : (user2Id + user1Id)
